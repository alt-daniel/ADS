...
public class RoutePlannerMain {
    ...
    public static void main(String[] args) {
        ...
        Junction diemen = roadMap.getVertexById("Diemen");
        Junction weesp = roadMap.getVertexById("Weesp");
        Road diemenToWeesp = diemen.getRoadBetweenJunctions(weesp);
        diemenToWeesp.setMaxSpeed(5);
    ...
    private static void doPathSearches(RoadMap roadMap, String fromId, String toId) {
        ...
        path = roadMap.aStarShortestPath(fromId, toId,
                Road::getTravelTime,
                Junction::getTravelTimeAtFixedSpeed
        );
