...
public class Employee implements Comparable<Employee> {
    ...
    public boolean equals(Object o) {
        return this.getNumber() == (((Employee) o).getNumber());
    }
    ...
    public void addEmployeeToManagedProject(Project p) {
        this.getManagedProjects().add(p);
    }

    public void addEmployeeToAssignedProject(Project p) {
        this.getAssignedProjects().add(p);
    }

    public int getNumOfProjects() {
        return this.getAssignedProjects().size();
    }
